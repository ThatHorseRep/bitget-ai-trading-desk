...
export class DecisionDeskService {
  ...
  async runWorkflow(
    ...
    let thesis, challenge, thesisPosition;
    try {
      if (options.useFixture) {
      ...
      return {
        ...
        parsedResult,
        artifact: null,
        limitations: [`Language reasoning layer failed: ${(err as Error).message}`]
      };
    }
    ...
    const decision = evaluateDecision({
      ...
      criticalBlockers: [],
      materialUncertainty: thesis.unresolvedAmbiguities.length > 0
    });

...
export function AuditHistoryModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/75 backdrop-blur-xs animate-fadeIn">
      <div className="w-full max-w-4xl max-h-[85vh] bg-[var(--rtd-paper)] border-2 border-[var(--rtd-ink)] shadow-2xl flex flex-col overflow-hidden">
        
        {/* Header Bar */}
        <div className="px-5 py-4 bg-[var(--rtd-paper-subtle)] border-b border-[var(--rtd-steel)]/30 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span className="w-2.5 h-2.5 bg-[var(--rtd-ink)]" />
            <div>
              <h2 className="text-sm sm:text-base font-bold uppercase tracking-wider text-[var(--rtd-ink)] font-mono">
                Institutional Audit Log
              </h2>
              <p className="text-[11px] font-mono text-[var(--rtd-steel)]">
          ...
          <div className="flex items-center gap-2">
            {history.length > 0 && (
              <>
                <button
                  ...
                  className="px-2.5 py-1 text-[11px] font-mono font-bold uppercase tracking-wider border border-[var(--rtd-steel)]/40 bg-[var(--rtd-paper)] text-[var(--rtd-ink)] hover:bg-[var(--rtd-paper-subtle)] cursor-pointer"
                >
                  Export JSON
                </button>
                <button
                  ...
                  className="px-2.5 py-1 text-[11px] font-mono font-bold uppercase tracking-wider border border-[var(--rtd-reject)] text-[var(--rtd-reject)] hover:bg-[var(--rtd-reject)] hover:text-white cursor-pointer"
                >
                  Clear All
                </button>
              </>
            ...
            <button
              type="button"
              onClick={onClose}
              className="p-1.5 text-[var(--rtd-steel)] hover:text-[var(--rtd-ink)] hover:bg-[var(--rtd-paper-subtle)] cursor-pointer text-sm font-mono font-bold"
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-3">
          {history.length === 0 ? (
            ...
            <div className="border border-[var(--rtd-steel)]/30 overflow-hidden">
        ...
        {/* Footer */}
        <div className="px-5 py-3 bg-[var(--rtd-paper-subtle)] border-t border-[var(--rtd-steel)]/30 flex items-center justify-between text-[11px] font-mono text-[var(--rtd-steel)]">
          <span>Click any audit entry to load its complete decision sheet onto the desk.</span>
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-1.5 bg-[var(--rtd-steel)]/10 text-[var(--rtd-ink)] font-bold uppercase tracking-wider hover:bg-[var(--rtd-steel)]/20 cursor-pointer"
          >
            Close
          </button>
        </div>

    ...
    <div className="mx-auto max-w-4xl space-y-6">
      <div className="rounded-2xl border border-zinc-200 bg-white p-6 sm:p-8 shadow-xs space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3.5 p-3 rounded-xl bg-indigo-50 border border-indigo-200 transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)]">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between">
                <h4 className="text-sm font-semibold [text-wrap:balance] text-indigo-950">
                  Analyzing Trade
                </h4>
